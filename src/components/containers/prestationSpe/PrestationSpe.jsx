            ...
            <div>
                ...
                <div className="Prestationspe_presentation">
                    <div className="Prestationspe_Presentation_text">
                        <h3 className="Prestationspe_Presentation_text_titre">Notre équipe, notre expertise</h3>
                ...
                <div className="Prestationspe_separation">
                    <h2 className="Prestationspe_Separation_titre">Réaliser votre site web à nos côtés</h2>
                    <button className="Prestationspe_Separation_button">Je réalise un devis</button>
                </div>
                <div className="Prestationspe_explication">
                    <h3 className="Prestationspe_Explication_accroche">Une méthode simple et efficace</h3>
                    <h2 className="Prestationspe_Explication_titre">Commercialiser vos produits ou services en ligne</h2>
                    <div className="Prestationspe_Explication_detail">
                        <div className="Prestationspe_Explication_Detail_text">
                            <h3>Mettez toutes les chances de votre côtés pour convertir un client</h3>
                            <p>bla bla bla bla faudra que je réflechisse à mettre un texte intéressant</p>
