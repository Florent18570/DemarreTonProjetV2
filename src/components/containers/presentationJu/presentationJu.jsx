...
const PresentationJu = () => {
  ...
  return (
    <section className="Presentation__glob">
      <div className="Presentation__left">
        ...
        <div className="Presentation__left__text">
          <p className="Presentation__left__text__p">
            <strong>Vous hésitez encore ?</strong> Jetez un œil à nos créations
            publiques directement depuis notre site web. Vous y trouverez une
            sélection de nos meilleures réalisations. Nous vous invitons à
            cliquer et naviguer au fil des pages pour découvrir l'étendue de nos
            compétences et notre créativité sans limites.&nbsp;
