export default function stockDataa() {
  const stockData = [
    {
      id: "0",
      ...
      processus: [
        {
          ...
          description:
            "la première étape, le code, pas évident, surtout quand on a des erreurs incompréhensive",
        },
        {
          etape: "2. Design des wireframes et de la maquette",
          description:
        ...
        },
        {
          etape: "3. Choix de la solution",
          description:
            "La solution devait s'intégrer dans l'écosystème déjà existant. La solution ? Intégrer du code et JSX c'est trop rapide ",
        },
        {
          etape: "4. Développement du site",
          description:
    ...
    {
      id: "4",
      compagnie: "vegan-website",
      intro: "En cours de development",
      service: "Site ecommerce",
      technologie: "Webflow",
      date: "Janvier 2022",
      site: "https://vegan-website-26bafb.webflow.io",
      link: "https://vegan-website-26bafb.webflow.io",
      src: "/images/stb18.webp",
      processus: [
        {
          etape: "1. Rédaction d'une charte graphique",
    ...
    {
      id: "5",
      compagnie: "aba-montpellier",
      intro: "Développé",
      service: "Site Vitrine",
      technologie: "Wordpress",
      date: "Septemblre 2023",
      site: "https://aba-montpellier.fr",
      link: "https://aba-montpellier.fr",
      src: "/images/abamontpellier.webp",
      processus: [
        {
          etape: "1. Rédaction d'une charte graphique",
          description:
